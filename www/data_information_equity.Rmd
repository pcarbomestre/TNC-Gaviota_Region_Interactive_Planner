...
<img src="img/demo_icon.png" alt="description of the image" style="vertical-align: middle; margin: 0px 10px; width: 5%"/>Demographics
...
You can access the original data here: [CalEnviroScreen 3.0, Pollution Burden, Percentile, 2017](https://sbcblueprint.databasin.org/datasets/77b443653446408fbe31aa9e86b6948d/)

<br>

<h4 style="display: inline-block;">

<img src="img/pollution_icon.png" alt="description of the image" style="vertical-align: middle; margin: 0px 10px; width: 5%"/>Pollution
...
<img src="img/access_icon.png" alt="description of the image" style="vertical-align: middle; margin: 0px 10px; width: 5%"/>Isolation from Nature
...
You can access the original data here: [Underserved Populations for Trail/Open Space Access](https://sbcblueprint.databasin.org/datasets/eb197ef158954edd936af070a524c782/)
